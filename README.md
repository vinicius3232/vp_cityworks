...
- **Minigames**: 4 NUI próprios (solda traça-trinca / voltímetro-disjuntores / fiação-cabos / martelo-construtor) + **ponte opcional p/ libs externas** (`Config.ExternalMinigames`, ex.: bl_ui/glitch) por 1 export, com fallback automático pro skillcheck.
